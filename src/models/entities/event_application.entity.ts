...
export class EventApplication {
  ...
  @ManyToOne(() => Period, (period) => period.eventApplications, { nullable: true, onDelete: 'SET NULL' })
  ...
  @OneToMany(() => AssistantApplication, (assistantApplication) => assistantApplication.event)
